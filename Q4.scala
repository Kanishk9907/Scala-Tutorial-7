object Q4 extends App {
    ...
    println("\nList of negative balances: " +overdraft(accountList))
    println("\nsum of all account balances: " +totalBalance(accountList))
    println("\nfinal balances of all accounts after apply the interest: " + interest(accountList))
}
